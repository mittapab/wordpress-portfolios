            ...
            <div class="col-md-7 col-xl-8">
                <div class="card border-0 box-shadow-01 rounded-1 bg-white">
                    <div class="card-body text-center">
                        <img class="img-fluid rounded-3" width="450"  style="height:600px;" src="<?php echo get_field('image_1');?>" alt="profile-image" />
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-8 col-sm-12">
                    <div class="card border-0 box-shadow-01 rounded-1 bg-white">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <div class="fs-6 profile-info-detail-title">สถานที่รับงาน</div>
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="card border-0 box-shadow-01 rounded-1 bg-white">
                        ...
                        <div class="row">
                           ...
                           <!-- <div class="col-2">
                              <img class="rounded-3" width="35" style="height:35;"  src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/LINE_New_App_Icon_%282020-12%29.png/800px-LINE_New_App_Icon_%282020-12%29.png" alt="profile-image" />
                           </div>
                           <div class="col-2">
                              <img class="rounded-3" width="35" style="height:35;"  src="https://seeklogo.com/images/F/facebook-icon-logo-AEF3A8F447-seeklogo.com.png" alt="profile-image" />
                           </div>
                           <div class="col-2">
                              <img class="rounded-3" width="35" style="height:35;"  src="https://cdn-icons-png.flaticon.com/512/906/906377.png" alt="profile-image" />
                           </div>
                           <div class="col-2">
                              <img class="rounded-3" width="35" style="height:35;"  src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/VK_Compact_Logo_%282021-present%29.svg/1024px-VK_Compact_Logo_%282021-present%29.svg.png" alt="profile-image" />
                           </div>
                           <div class="col-2">
                              <img class="rounded-3" width="35" style="height:35;"  src="https://cdn-icons-png.flaticon.com/512/61/61353.png" alt="profile-image" />
                           </div> -->
                        ...
                        <!-- <p>รีวิว :  <img class="rounded-3" width="150"  style="height:100px;" src="https://static.vecteezy.com/system/resources/thumbnails/009/663/927/small/5-star-rating-review-star-transparent-free-png.png" /></p> -->
                        <p>
                        <h5 style="font-size:18px;padding-top:8px;">เรตติ้งรีวิว <?php echo get_field('en_ratting')."/5" ?></h5>
                        <?php  for($i=1; $i<=5; $i++){
