<?php
class Qiupid_Customizer_Control_Radio extends Qiupid_Customizer_Control_Base {
	public $disabled_msg;
	...
	static function field_template() {
		echo '<script type="text/html" id="tmpl-field-qiupid-radio">';
		self::before_field();
		?>
		<#
