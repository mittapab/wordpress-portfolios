<?php
class Qiupid_Customizer_Control_Modal extends Qiupid_Customizer_Control_Base {
	static function field_template() {
		echo '<script type="text/html" id="tmpl-field-qiupid-modal">';
		self::before_field();
		?>
		...
		<div class="qiupid-actions">
			...
			<a href="#" title="<?php esc_attr_e( 'Toggle edit panel', 'qiupid' ); ?>" class="action--edit" data-control="{{ field.name }}"><span class="dashicons dashicons-edit"></span></a>
		</div>
