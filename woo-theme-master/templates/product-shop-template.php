                                ...
                                <div class="widget-desc">
                                    ...
                                    <div class="single-recommended-product d-flex mb-30">
                                        <div class="single-recommended-thumb mr-3">
                                            <img src="<?php echo get_theme_file_uri('img/product-img/product-10.jpg');?>" alt="">
                                        </div>
                                    ...
                                    <div class="single-recommended-product d-flex">
                                        <div class="single-recommended-thumb mr-3">
                                            <img src="<?php echo get_theme_file_uri('img/product-img/product-12.jpg');?>" alt="">
                                        </div>
                                        <div class="single-recommended-desc">
                        ...
                        <div class="shop_grid_product_area">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig" data-wow-delay="1s">
                                    ...
                                    <div class="product-img">
                                        <img src="<?php echo get_theme_file_uri('img/product-img/product-9.jpg');?>" alt="">
                                ...
                                if($query_product->have_posts()){
                                    ...
                                    <div class="product-description">
                                        ...
                                        echo apply_filters(
                                            ...
                                            sprintf(
                                                '<a href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" class="add-to-cart-btn button %s product_type_%s">%s</a>',
