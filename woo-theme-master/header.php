                    ...
                    <div class="row h-100 align-items-center justify-content-end">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                <!-- Logo Area -->
                                <div class="top_logo">
                                    <a href="#"><img src="<?php echo get_theme_file_uri('/img/core-img/logo.png'); ?>" alt=""></a>
                                </div>
                                <!-- Cart & Menu Area -->
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    ...
                                    <div class="cart">
                                        ...
                                        <ul class="cart-list">
                                            <li>
                                                <a href="#" class="image"><img src="<?php echo get_theme_file_uri('/img/product-img/product-10.jpg'); ?>" class="cart-thumb" alt=""></a>
                                            ...
                                            <li>
                                                <a href="#" class="image"><img src="<?php echo get_theme_file_uri('/img/product-img/product-11.jpg'); ?>" class="cart-thumb" alt=""></a>
                                                <div class="cart-item-desc">
                                                    <h6><a href="#">Women's Fashion</a></h6>
                                                    <p>1x - <span class="price">$10</span></p>
                                                </div>
                                ...
                                <nav class="navbar navbar-expand-lg align-items-start">
                                    ...
                                    <div class="collapse navbar-collapse align-items-start collapse" id="karl-navbar">
                                        <ul class="navbar-nav animated" id="nav">
                                            ...
                                            <li class="nav-item active"><a class="nav-link" href="<?php echo site_url("/shop-product");  ?>">Shop</a></li>
