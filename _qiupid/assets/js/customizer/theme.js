...
(function () {
     ...
     */
    Qiupid.prototype.checkTouchScreen = function () {
     ...
     * @return bool
     */
    Qiupid.prototype.isMobile = function () {
        if (
     ...
     */
    Qiupid.prototype.initMenuSidebar = function () {
     ...
     * @todo Need check
     */
    Qiupid.prototype.initMobieSearchForm = function () {
    ...
    Qiupid.prototype.toggleMobileSubmenu = function (e) {
        e.preventDefault();
        var that = this;
     ...
     */
    Qiupid.prototype.toggleMobileSubmenuEvents = function (toggleIcon) {
     ...
     */
    Qiupid.prototype.initMobileSubMenu = function () {
     ...
     */
    Qiupid.prototype.slideUp = function (element, duration, callBack) {
     ...
     * @param function callBack
     */
    Qiupid.prototype.slideDown = function (element, duration, callBack) {
        if (typeof duration !== 'number') {
            duration = 0;
        }
    ...
    Qiupid.prototype.insertMenuOverlayClass = function () {
    ...
    Qiupid.prototype.setupMobileItemAnimations = function (element) {
        var h = window.height;
     ...
     */
    Qiupid.prototype.toggleClass = function (element, className) {
     ...
     * @param string className
     */
    Qiupid.prototype.addClass = function (element, className) {
        if (element instanceof NodeList) {
            for (var i = 0; i < element.length; i++) {
                element[i].classList.add(className);
            }
     ...
     * @param string className
     */
    Qiupid.prototype.removeClass = function (element, className) {
     ...
     * @param function callBack
     */
    Qiupid.prototype.addEvent = function (element, event, callBack) {
        if (element instanceof NodeList) {
            for (var i = 0; i < element.length; i++) {
     ...
     * Close menu sidebar.
     */
    Qiupid.prototype.closeMenuSidebar = function () {
     ...
     */
    Qiupid.prototype.toggleMenuSidebar = function (toggle) {
     ...
     */
    Qiupid.prototype.searchFormAutoAlign = function () {
     ...
     * Search form.
     */
    Qiupid.prototype.initSearchForm = function () {
        var searchItems = document.querySelectorAll('.header-search_icon-item');
        var that = this;
     ...
     * @return Element
     */
    Qiupid.prototype.wrapper = function (element, tag) {
     ...
     * Responsive table.
     */
    Qiupid.prototype.responsiveTable = function () {
     ...
     */
    Qiupid.prototype.responsiveVideos = function () { };

    /**
     * Inittial
     */
    Qiupid.prototype.init = function () {
        ...
        document.addEventListener(
            ...
            function (e) {
                ...
                if ('qiupid_customize_render_header' === e.detail) {
                ...
                if ('Qiupid_Builder_Item_Search_Icon__render' === e.detail) {
                    this.initMobieSearchForm();
                    this.initSearchForm();
                    this.setupMobileItemAnimations();
                }
     ...
     * @deprecated 0.2.6
     */
    function qiupid_is_mobile() {
        return Qiupid.isMobile();
    }

    window.qiupid_is_mobile = qiupid_is_mobile;
    window.Qiupid = new Qiupid();

    /**
     * Fix viewport units on Mobile.
     */
    (function () {
        if (window.Qiupid.isMobile()) {
            /**
