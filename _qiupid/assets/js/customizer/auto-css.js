var QiupidAutoCSS = window.QiupidAutoCSS || null;

( function( $, api ) {

    QiupidAutoCSS = function(){
        this.values = {};
        this.lastValues = {};
        this.devices = [ 'desktop', 'tablet', 'mobile' ];
    };
    QiupidAutoCSS._change = false;
    QiupidAutoCSS.prototype.fonts = {};
    QiupidAutoCSS.prototype.styling_fields = {
        color: null,
        image: null,
        position: null,
        cover: null,
    ...
    QiupidAutoCSS.prototype.subsets = {};
    QiupidAutoCSS.prototype.variants = {};
    QiupidAutoCSS.prototype.media_queries = {
        all: '%s',
        desktop: '%s',
    ...
    QiupidAutoCSS.prototype.box_shadow_fields = {
        color:  null,
        x:  0,
        y:  0,
        blur:  0,
    ...
    QiupidAutoCSS.prototype.reset = function(){
        this.fonts = {};
        this.subsets = {};
        this.variants = {};
        this.css = {
    ...
    QiupidAutoCSS.prototype.encodeValue =function( value ){
        return encodeURI( JSON.stringify( value ) )
    };
    QiupidAutoCSS.prototype.decodeValue = function( value ){
        return JSON.parse( decodeURI( value ) );
    };

    QiupidAutoCSS.prototype.loop_fields = function( fields, values, skip_if_val_null, no_selector ){
    ...
    QiupidAutoCSS.prototype.run = function( setting_name ){
        ...
        if ( window.Qiupid_JS ) {
            if ( window.Qiupid_JS.css_media_queries ) {
                this.media_queries = window.Qiupid_JS.css_media_queries;
            }
        }
        this.reset();

        var that = this;
        that.loop_fields( Qiupid_Preview_Config.fields );
        ...
        if ( $( '#qiupid-google-font-css' ).length <= 0 ) {
            $( 'head' ).prepend( "<link rel='stylesheet' id='qiupid-google-font-css'  href='' type='text/css' media='all' />" );
        }

        if ( url ) {
            //css_code = "\r\n@import url('"+url+"');\r\n\r\n"+css_code;
            $( '#qiupid-google-font-css' ).attr( 'href', url );
        } else {
            $( '#qiupid-google-font-css' ).remove();
        }

        css_code = css_code.trim();
        if ( $( '#qiupid-style-inline-css' ).length <= 0 ) {
            $( 'head' ).append( "<style id='qiupid-style-inline-css' type='text/css'></style>" )
        }
        $( '#qiupid-style-inline-css' ).html( css_code );
    ...
    QiupidAutoCSS.prototype.get_setting = function(name, device, key  ){
        ...
        var value;
        var df = false;
        if ( !_.isUndefined( Qiupid_Preview_Config.fields['setting|'+name ] ) ) {
            var field = Qiupid_Preview_Config.fields['setting|'+name ];
    ...
    QiupidAutoCSS.prototype.get_google_fonts_url = function(){
    ...
    QiupidAutoCSS.prototype.join = function( object, glue ){
    ...
    QiupidAutoCSS.prototype.str_value = function( value, format, value_no_unit ){
        if ( _.isEmpty( value ) ) {
            return '';
        }
    ...
    QiupidAutoCSS.prototype.setup_color = function( value, format ){
        if ( format ) {
            if ( value ) {
    ...
    QiupidAutoCSS.prototype.setup_checkbox = function( value, format ){
        if ( format ) {
            if ( value ) {
                return format;
            }
    ...
    QiupidAutoCSS.prototype.setup_image = function( value, format ){
    ...
    QiupidAutoCSS.prototype.setup_slider = function ( value, format ){
        if ( ! _.isObject( value ) ) {
            value = {};
        }
    ...
    QiupidAutoCSS.prototype.setup_shadow = function ( value, format ){
        var that = this;
        if ( ! _.isObject( value ) ) {
            return '';
        }
    ...
    QiupidAutoCSS.prototype.setup_default = function( value, format ){
        if ( format ) {
            if ( value ) {
                return this.str_value( value, format );
            }
    ...
    QiupidAutoCSS.prototype.setup_css_ruler = function ( value, format ){
        if ( ! _.isObject( value ) ) {
            value = {};
        }
        value = _.defaults( value, {
    ...
    QiupidAutoCSS.prototype.setup_text_align = function( value, format ) {
        if ( format  ) {
            if ( value ) {
                return this.str_value( value, format );
            }
    ...
    QiupidAutoCSS.prototype.sanitize_color = function ( color ){
       return color;
    };

    QiupidAutoCSS.prototype.sanitize_slider = function ( value ){
        value = _.defaults( value, {
            unit: 'px',
            value: null
        });
    ...
    QiupidAutoCSS.prototype.sanitize_media = function ( value ) {
        if ( ! _.isObject( value ) ) {
            value = {};
        }
    ...
    QiupidAutoCSS.prototype.maybe_devices_setup = function( field, call_back, values, no_selector ) {
        var code = '';
        var code_array = {};
    ...
    QiupidAutoCSS.prototype.setup_font = function ( value ){
        if( ! _.isObject( value ) ) {
            value = {};
        }
        value = _.defaults( value, {
    ...
    QiupidAutoCSS.prototype.font = function( field, values ){
        var code = '';
        var that = this;
    ...
    QiupidAutoCSS.prototype.css_ruler = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_css_ruler', value, no_selector );
    };

    QiupidAutoCSS.prototype.shadow = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_shadow', value, no_selector );
    };

    QiupidAutoCSS.prototype.slider = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_slider', value, no_selector );
    };

    QiupidAutoCSS.prototype.color = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_color', value, no_selector );
    };

    QiupidAutoCSS.prototype.checkbox = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_checkbox', value, no_selector );
    };

    QiupidAutoCSS.prototype.image = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_image', value, no_selector );
    };

    QiupidAutoCSS.prototype.text_align = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_text_align', value, no_selector );
    };

    QiupidAutoCSS.prototype.setup_styling_fields = function( fields, list, selectors, type ){
        var that  = this;
        var newfs;
        var i;
        var newList = [];
    ...
    QiupidAutoCSS.prototype.styling = function( field ){
        var that = this;
        ...
        var listNormalFields = that.setup_styling_fields( normal_fields,  Qiupid_Preview_Config.styling_config.normal_fields, selectors, 'normal' );
        var listHoverFields = that.setup_styling_fields( hover_fields,  Qiupid_Preview_Config.styling_config.hover_fields, selectors, 'hover' );

        var listTabs = _.clone( Qiupid_Preview_Config.styling_config.tabs );
        if ( tabs === false ) {
    ...
    QiupidAutoCSS.prototype.modal = function ( field ){
        var that = this;
        var values = this.get_setting( field.name, 'all' );
        if ( ! _.isObject( values ) ) {
            values = {};
    ...
    QiupidAutoCSS.prototype.setup_font_style = function ( value ){
        if ( ! _.isObject( value ) ) {
            value = {};
        }
    ...
    QiupidAutoCSS.prototype.html_replace = function( field, value ){
    ...
    QiupidAutoCSS.prototype.html_class = function( field, v ){
        var value;
        if ( _.isUndefined( v ) ) {
            value = _.clone( v );
        } else {
    ...
    QiupidAutoCSS.prototype.typography = function( field, values ){
        ...
        var fields = {};
        var devices_css = {};
        _.each( Qiupid_Preview_Config.typo_fields, function( f ){
            fields[ f.name ] = f;
        } );
    ...
    var QiupidAutoCSSInit = new QiupidAutoCSS();

    api.bind( 'preview-ready', function() {
        //QiupidAutoCSSInit.run();
        QiupidAutoCSSInit.lastValues = api.get();
        QiupidAutoCSSInit.values = api.get();
    });
