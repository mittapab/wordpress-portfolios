...
class Qiupid_Builder_Item_Navigation_2 {
	public $id = 'navigation2';

	function item() {
		return array(
			'name'    => esc_html__( 'Navigation 2', 'qiupid' ),
			'id'      => $this->id,
			'width'   => '6',
	...
	function customize() {
		...
		$config  = array(
			array(
				...
				'theme_supports' => '',
				'title'          => esc_html__( 'Navigation 2', 'qiupid' ),
				'description'    => sprintf( __( 'Assign <a href="#menu_locations"  class="focus-section">Menu Location</a> for %1$s', 'qiupid' ), esc_html__( 'Navigation 2', 'qiupid' )),
			),

			array(
				'name'            => 'qiupid_navigation2_style',
				'type'            => 'image_select',
				'section'         => $section,
			...
			array(
				'name'       => 'qiupid_navigation2_style_border_h',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'max'        => 20,
			...
			array(
				'name'       => 'qiupid_navigation2_style_border_pos',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'min'        => - 50,
			...
			array(
				'name'       => 'qiupid_navigation2_style_border_color',
				'type'       => 'color',
				'section'    => $section,
				'selector'   => 'format',
			...
			array(
				'name'           => 'qiupid_navigation2__hide-arrow',
				'type'           => 'checkbox',
				'section'        => $section,
				'selector'       => '.builder-item--' . $this->id . " .{$this->id}",
			...
			array(
				'name'            => 'qiupid_navigation2_arrow_size',
				'type'            => 'slider',
				...
				'required'        => array( 'qiupid_navigation2__hide-arrow', '!=', 1 ),
			),

			array(
				'name'    => 'qiupid_navigation2_top_heading',
				'type'    => 'heading',
				'section' => $section,
			...
			array(
				'name'        => 'qiupid_navigation2_item_styling',
				'type'        => 'styling',
				'section'     => $section,
			...
			array(
				'name'        => 'qiupid_navigation2_typography',
				'type'        => 'typography',
				'section'     => $section,
	 ...
	 */
	function render() {
		$style = sanitize_text_field( Qiupid()->get_setting( 'qiupid_navigation2_style' ) );
		if ( $style ) {
			$style = sanitize_text_field( $style );
		}

		$hide_arrow = sanitize_text_field( Qiupid()->get_setting( 'qiupid_navigation2__hide-arrow' ) );
		if ( $hide_arrow ) {
 ...
 * @return mixed
 */
function qiupid_change_nav_menu_item_id_navigation2( $string_id, $item, $args ) {
...
add_filter( 'nav_menu_item_id', 'qiupid_change_nav_menu_item_id_navigation2', 55, 3 );

// Register header item.
Qiupid_Customize_Layout_Builder()->register_item( 'header', new Qiupid_Builder_Item_Navigation_2() );
