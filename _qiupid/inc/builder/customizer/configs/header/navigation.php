...
class Qiupid_Builder_Item_Navigation_1 {
	public $id = 'navigation1';

	function item() {
		return array(
			'name'    => esc_html__( 'Navigation 1', 'qiupid' ),
			'id'      => $this->id,
			'width'   => '6',
			'section' => 'header_navigation1',
		);
	}
	...
	function customize() {
		...
		$config  = array(
			array(
				'name'           => 'header_navigation1',
				'type'           => 'section',
				'panel'          => 'header_settings',
				'theme_supports' => '',
				'title'          => esc_html__( 'Navigation 1', 'qiupid' ),
				'description'    => sprintf( __( 'Assign <a href="#menu_locations"  class="focus-section">Menu Location</a> for %1$s', 'qiupid' ), esc_html__( 'Navigation 1', 'qiupid' ) ),
			),

			array(
				'name'            => 'qiupid_navigation1_style',
				'type'            => 'image_select',
				'section'         => $section,
			...
			array(
				'name'       => 'qiupid_navigation1_style_border_h',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'max'        => 20,
			...
			array(
				'name'       => 'qiupid_navigation1_style_border_pos',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'min'        => - 50,
			...
			array(
				'name'       => 'qiupid_navigation1_style_border_color',
				'type'       => 'color',
				'section'    => $section,
				'selector'   => 'format',
			...
			array(
				'name'           => 'qiupid_navigation1__hide-arrow',
				'type'           => 'checkbox',
				'section'        => $section,
				'selector'       => '.builder-item--' . $this->id . " .{$this->id}",
			...
			array(
				'name'            => 'qiupid_navigation1_arrow_size',
				'type'            => 'slider',
				...
				'css_format'      => ".builder-item--navigation1 .nav-icon-angle { width: {{value}}; height: {{value}}; }",
				'required'        => array( 'qiupid_navigation1__hide-arrow', '!=', 1 ),
			),

			array(
				'name'    => 'qiupid_navigation1_top_heading',
				'type'    => 'heading',
				'section' => $section,
			...
			array(
				'name'        => 'qiupid_navigation1_typography',
				'type'        => 'typography',
				'section'     => $section,
				'title'       => esc_html__( 'Menu Items Typography', 'qiupid' ),
				'description' => esc_html__( 'Typography for menu', 'qiupid' ),
				'selector'    => ".navigation1 .nav-menu>li > a,.builder-item-sidebar .primary-menu-sidebar .primary-menu-ul > li > a, .builder-item-sidebar .primary-menu-sidebar .primary-menu-ul .sub-menu a",
	 ...
	 */
	function render() {
		$style = sanitize_text_field( Qiupid()->get_setting( 'qiupid_navigation1_style' ) );
		if ( $style ) {
			$style = sanitize_text_field( $style );
		}

		$hide_arrow = sanitize_text_field( Qiupid()->get_setting( 'qiupid_navigation1__hide-arrow' ) );
		if ( $hide_arrow ) {
		...
		wp_nav_menu(
			array(
				'theme_location'  => 'hb-menu-navigation1',
				'container'       => false,
				'container_id'    => false,
 ...
 * @return mixed
 */
function qiupid_change_nav_menu_item_id_navigation( $string_id, $item, $args ) {
	if ( 'hb-menu-navigation1' == 'hb-menu-navigation1' || 'menu-2' == 'hb-menu-navigation1' ) {
...
add_filter( 'nav_menu_item_id', 'qiupid_change_nav_menu_item_id_navigation', 55, 3 );


// Register header item.
Qiupid_Customize_Layout_Builder()->register_item( 'header', new Qiupid_Builder_Item_Navigation_1() );
