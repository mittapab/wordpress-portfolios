 ...
 */
final class Elementor_WidgetTemplate {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-widgettemplate' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_WT ) );
