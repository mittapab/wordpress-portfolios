...
<div class="line-contact">
    ...
    <div class="menu-footer">
        <div class="d-flex flex-row">
		     <?php if ( is_active_sidebar( 'btwin-top-menu-mobile' ) ) : ?>
                     <?php dynamic_sidebar( 'btwin-top-menu-mobile' ); ?>
             <?php endif; ?> 
        </div>
    </div>
	...
	<style>
		...
		.loadercontain .spincontain-logo {
			position: fixed;
			top: 50%;
			left: 0;
			right: 0;
    ...
    <!-- Spin -->
    <div class="loadercontain" style="display: none">
        <div class="spincontain">
            <div class="boxload"></div>
        </div>
        <img src="<?php echo get_theme_file_uri('/public/img/logo.png'); ?>" class="spincontain-logo mb-2" />
        <div id="loadmeta"></div>
    </div>
    <!-- End Spin -->
